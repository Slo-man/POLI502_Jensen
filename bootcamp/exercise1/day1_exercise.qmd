...
Redo the calculation in 2-1 (Multiply 4 by 30 plus 6, and then raise the answer to the power of 0.5), but this time do so by creating objects. Take the following steps:
